...
class SinglePageOPALTest {
	...
	void createRunStructureOPAL_Normal() {
		...
		assertEquals("Material for Test-Term", shortTitle.getTextContent(), "Text is wrong");
		//
	...
	void createTreeStructureOPAL_Normal() {
		...
		assertEquals("Material for Test-Term", cnShortTitle.getTextContent(), "Text is wrong");
